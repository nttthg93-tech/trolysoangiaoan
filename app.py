...
<div class="main-header">
    ...
    <p>Tác giả: Nguyễn Thị Thanh Thủy - Trường PTDTBT Tiểu học Trung Thịnh - ĐT: 034 5504 680</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Nguyễn Thị Thanh Thủy - Trường PTDTBT Tiểu học Trung Thịnh - ĐT: 034 5504 680</div>", unsafe_allow_html=True)
